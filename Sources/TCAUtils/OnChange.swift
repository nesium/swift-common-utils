...
// Source: https://github.com/pointfreeco/isowords/blob/main/Sources/TcaHelpers/OnChange.swift
...
struct ChangeReducer<Base: ReducerProtocol, ChildState: Equatable>: ReducerProtocol {
  ...
  init(
    ...
    perform: @escaping (ChildState, ChildState, inout Base.State, Base.Action)
